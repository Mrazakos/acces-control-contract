...
export interface AccessControlOptimizedInterface extends utils.Interface {
  functions: {
    ...
    "lockExists(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "lockExists", data: BytesLike): Result;
...
export interface AccessControlOptimized extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccessControlOptimizedInterface;
  ...
  filters: {
    ...
    "ContractUnpaused(address)"(
      unpauser?: PromiseOrValue<string> | null
    ...
    "LockRegistered(uint256,address,string)"(
      lockId?: PromiseOrValue<BigNumberish> | null,
      lockOwner?: PromiseOrValue<string> | null,
      publicKey?: null
